...
public class Bishop extends Piece {
    ...
    void findAttackSq() {
        ...
        //adds all squars it can move to
    }
    ...
    void findMovementSq(List<Piece> piecesInPlay) {
        ...
        for (int i = 0; i < piecesInPlay.size(); i++) {
            if (movementSq.contains(piecesInPlay.get(i).getPosition())) {
                System.out.println(piecesInPlay.get(i).toString());
                ...
                if (piecesInPlay.get(i).getColour() == colour) { // checking colour of blocading piece
                    ...
                    movementSq.removeFirstOccurrence(piecesInPlay.get(i).getPosition());//this code figures out where the blocading piece is in relation to the bishop and calcs which squares to remove
